...
This R notebook contains the code used to analyse:
  - some meta information associated with the different strains used in this study (all strains but the ECOR72)
